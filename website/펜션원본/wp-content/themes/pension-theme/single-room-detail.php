...
<p class="theme-guide">
  ...
  레이아웃은 테마폴더의 single-room-detail.php, single-room-detail.scss에서 수정하실 수 있습니다
</p>
<!--post(글) 출력시작-->
...
<ul class="book-guide-link">
  <li><a class='guide-link' href="<?php bloginfo('url'); ?>/book/book-guide/">예약가이드</a></li>

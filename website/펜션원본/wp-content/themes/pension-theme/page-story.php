<?php include 'sub-header.php' ?>
  <script src="<?php bloginfo('template_directory'); ?> /js/page-story.js" defer></script>
  <!--페이지 제목 출력-->
 <h2 class="sub-title"> <?php the_title(); ?></h2>

<!--  페이지 본문에서 직접 작성 -->
  <p class="theme-guide">
    해당페이지는 page-story.php에서 수정하실 수 있습니다.
  </p> 
  <div class="sub-desc">
    <p>한번더 쉬게 되는 편안함, 쾌적한 자연이 한데 어우러져 있는곳</p>  
  </div> 
  <!--페이지 출력 시작-->
  ...
  <section class="greet-story">
    ...
    <p>
      ...
      <br>
      연인, 친구, 가족과 함께 잊지 못할 추억을 만들어 가시길 바랍니다. 
    </p>
  </section>
  <!--페이지 본문 출력-->

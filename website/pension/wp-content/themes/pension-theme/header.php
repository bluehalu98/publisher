...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/around&facility.css"> 
  <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/event-calendar.css"> 
  <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/book-guide.css"> 
...
<body id="style-6" <?php body_class(); ?>>
  ...
  <nav class="gnb">
    <div id="style-3" class="menu-wrap ">
